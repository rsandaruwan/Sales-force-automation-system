...
import 'package:sfasystem/ui/widgets/input_field.dart';
...
class _AddTaskPageState extends State<AddTaskPage> {
  ...
  int _selectedRemained = 5;
  List<int> remainedList=[
    5,10,16,20,
  ];
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              MyInputField(title: "Remind", hint: "$_selectedRemained minutes early",
              widget: DropdownButton(
                ...
                onChanged: (String? newValue) {
                  setState(() {
                    _selectedRemained = int.parse(newValue!);
                  });
                },
                items:remainedList.map<DropdownMenuItem<String>>(
                        (int value){
